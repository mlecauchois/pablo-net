...
if __name__ == "__main__":
    ...
    parser.add_argument("--url", type=str, help="URL of server", default="ws://4.210.240.225:5678")
    parser.add_argument("--prompt", type=str, help="Prompt to send to server")
    parser.add_argument(
        "--negative_prompt", type=str, help="Negative prompt to send to server", default="low quality"
    )
